...
<h3 align="center">I’m a DevOps Intern at Rakuten Advertising and a Linux enthusiast transitioning from a 20-year career in the military and law enforcement to the tech industry. My experience as an Army and NYPD Sergeant honed my leadership and problem-solving skills, which I now apply to cloud security, automation, and Infrastructure as Code (IaC).

Currently pursuing a B.S. in Computer Security Technology (GPA: 3.97) at Farmingdale State College and holding a CompTIA Security+ certification, I’ve built hands-on expertise in Linux server management, Dynamic DNS, Active Directory, and cloud networking. My technical skills include Docker, Ansible, Traefik, AWS, GCP, Prometheus, Grafana, and Wazuh.
